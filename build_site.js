      ...
      <div class="w-full px-6 sm:px-12 lg:px-20 py-8 flex-1 flex flex-col justify-center">
        <div class="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
          ...
          <div class="lg:col-span-5 space-y-8 border-t lg:border-t-0 lg:border-l border-white/10 pt-8 lg:pt-0 lg:pl-12">
            ...
            <!-- Redes Sociales Oficiales Solycal (solycal.es) en formato Iconos -->
            <div>
              <p class="font-mono text-xs text-brand-yellow uppercase tracking-widest mb-3">// REDES SOCIALES</p>
              <div class="flex items-center gap-3">
                <a href="https://www.linkedin.com/company/solycal/" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn Solycal" title="LinkedIn" class="w-10 h-10 rounded-full bg-white/5 border border-white/10 hover:border-brand-yellow hover:bg-brand-yellow/10 flex items-center justify-center text-neutral-300 hover:text-brand-yellow transition-all group">
                  <i data-lucide="linkedin" class="w-4 h-4 group-hover:scale-110 transition-transform"></i>
                </a>
                <a href="https://www.instagram.com/solycal_/" target="_blank" rel="noopener noreferrer" aria-label="Instagram Solycal" title="Instagram" class="w-10 h-10 rounded-full bg-white/5 border border-white/10 hover:border-brand-yellow hover:bg-brand-yellow/10 flex items-center justify-center text-neutral-300 hover:text-brand-yellow transition-all group">
                  <i data-lucide="instagram" class="w-4 h-4 group-hover:scale-110 transition-transform"></i>
                </a>
                <a href="https://www.facebook.com/solycal" target="_blank" rel="noopener noreferrer" aria-label="Facebook Solycal" title="Facebook" class="w-10 h-10 rounded-full bg-white/5 border border-white/10 hover:border-brand-yellow hover:bg-brand-yellow/10 flex items-center justify-center text-neutral-300 hover:text-brand-yellow transition-all group">
                  <i data-lucide="facebook" class="w-4 h-4 group-hover:scale-110 transition-transform"></i>
                </a>
                <a href="https://www.youtube.com/channel/UC4_Yk1tJqoAFrBOQ-fi4T7w" target="_blank" rel="noopener noreferrer" aria-label="YouTube Solycal" title="YouTube" class="w-10 h-10 rounded-full bg-white/5 border border-white/10 hover:border-brand-yellow hover:bg-brand-yellow/10 flex items-center justify-center text-neutral-300 hover:text-brand-yellow transition-all group">
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-10 py-16 border-b border-white/5">
        <div class="lg:col-span-4 space-y-4">
          ...
          <div class="pt-1 flex items-center gap-2.5">
            <a href="https://www.linkedin.com/company/solycal/" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn Solycal" title="LinkedIn" class="w-9 h-9 rounded-full bg-white/5 border border-white/10 hover:border-brand-yellow hover:bg-brand-yellow/10 flex items-center justify-center text-neutral-400 hover:text-brand-yellow transition-all group">
              <i data-lucide="linkedin" class="w-4 h-4 group-hover:scale-110 transition-transform"></i>
            </a>
            <a href="https://www.instagram.com/solycal_/" target="_blank" rel="noopener noreferrer" aria-label="Instagram Solycal" title="Instagram" class="w-9 h-9 rounded-full bg-white/5 border border-white/10 hover:border-brand-yellow hover:bg-brand-yellow/10 flex items-center justify-center text-neutral-400 hover:text-brand-yellow transition-all group">
              <i data-lucide="instagram" class="w-4 h-4 group-hover:scale-110 transition-transform"></i>
            </a>
            <a href="https://www.facebook.com/solycal" target="_blank" rel="noopener noreferrer" aria-label="Facebook Solycal" title="Facebook" class="w-9 h-9 rounded-full bg-white/5 border border-white/10 hover:border-brand-yellow hover:bg-brand-yellow/10 flex items-center justify-center text-neutral-400 hover:text-brand-yellow transition-all group">
              <i data-lucide="facebook" class="w-4 h-4 group-hover:scale-110 transition-transform"></i>
            </a>
            <a href="https://www.youtube.com/channel/UC4_Yk1tJqoAFrBOQ-fi4T7w" target="_blank" rel="noopener noreferrer" aria-label="YouTube Solycal" title="YouTube" class="w-9 h-9 rounded-full bg-white/5 border border-white/10 hover:border-brand-yellow hover:bg-brand-yellow/10 flex items-center justify-center text-neutral-400 hover:text-brand-yellow transition-all group">
              <i data-lucide="youtube" class="w-4 h-4 group-hover:scale-110 transition-transform"></i>
            </a>
          </div>
          <div class="pt-2">
      ...
      <div class="pt-8 flex flex-col sm:flex-row items-center justify-between gap-4 font-mono text-xs text-neutral-500">
        ...
        <div class="flex items-center gap-6">
          <div class="flex items-center gap-4 text-neutral-400">
            <a href="https://www.linkedin.com/company/solycal/" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn" class="hover:text-brand-yellow transition-colors"><i data-lucide="linkedin" class="w-3.5 h-3.5"></i></a>
            <a href="https://www.instagram.com/solycal_/" target="_blank" rel="noopener noreferrer" aria-label="Instagram" class="hover:text-brand-yellow transition-colors"><i data-lucide="instagram" class="w-3.5 h-3.5"></i></a>
            <a href="https://www.facebook.com/solycal" target="_blank" rel="noopener noreferrer" aria-label="Facebook" class="hover:text-brand-yellow transition-colors"><i data-lucide="facebook" class="w-3.5 h-3.5"></i></a>
            <a href="https://www.youtube.com/channel/UC4_Yk1tJqoAFrBOQ-fi4T7w" target="_blank" rel="noopener noreferrer" aria-label="YouTube" class="hover:text-brand-yellow transition-colors"><i data-lucide="youtube" class="w-3.5 h-3.5"></i></a>
          </div>
