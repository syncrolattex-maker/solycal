...
<head>
  ...
  <style>
    ...
    /* EFECTO TEXT DECODE EN TÍTULOS GRANDES */
    .decode-word {
  ...
  <script>
    ...
    window.addEventListener('DOMContentLoaded', () => {
      ...
      if (typeof gsap !== 'undefined') {
        ...
        // =========================================================================
        // EFECTO TEXT DECODE EN TÍTULOS GRANDES A MEDIDA QUE APARECEN
        // =========================================================================
        const headingsToDecode = document.querySelectorAll('h1, h2');

        headingsToDecode.forEach(heading => {
          if (heading.closest('#joby-nav-overlay') || heading.dataset.decodeReady) return;
          heading.dataset.decodeReady = "true";
            ...
            if (node.nodeType === Node.TEXT_NODE) {
              ...
              parts.forEach(part => {
                ...
                if (/^\\s+$/.test(part)) {
                  ...
                  wordSpan.className = 'decode-word';
          ...
          const charNodes = heading.querySelectorAll('.decode-char');
          if (charNodes.length === 0) return;

          // Estado inicial: transparente y ligeramente desplazado para decodificarse limpiamente
          gsap.set(charNodes, {
            opacity: 0,
            y: 8,
            filter: "blur(4px)"
          ...
          // Función para ejecutar el efecto Text Decode limpio
          const runTextDecode = () => {
            if (heading.dataset.decoded === "true") return;
            heading.dataset.decoded = "true";
          ...
          if (heading.classList.contains('hero-title')) {
            setTimeout(runTextDecode, hasLoadedBefore ? 350 : 2550);
          } else {
...
<div id="services-page-container" class="relative bg-[#07080a] overflow-hidden">
  ...
  <div class="relative z-10">
    ...
    <section class="p-0 relative" id="services-accordion-section">
      ...
      <div class="w-full">
        ...
        <style>
          ...
          /* ---- MOBILE VERTICAL EXPANDING ACCORDION (SUPAH ELASTIC EFFECT) ---- */
          #srv-cols-mob {
          ...
          /* Fila Móvil Comprimida (Cerrada) — Cabecera visible 56px */
          .srv-mob-col.is-compressed {
            background-color: #07080a;
          }
          .srv-mob-col.is-compressed .srv-mob-body {
            pointer-events: none !important;
            opacity: 0;
          }
          .srv-mob-col.is-compressed .srv-mob-num {
            color: rgba(241, 181, 65, 0.7);
          }
          .srv-mob-col.is-compressed .srv-mob-title {
            color: rgba(255, 255, 255, 0.75);
          }

          /* Fila Móvil Activa (Abierta) — Expandida con elastic spring */
          .srv-mob-col.is-active {
            background-color: #090b0e;
          }
          .srv-mob-col.is-active .srv-mob-body {
            pointer-events: auto !important;
            opacity: 1;
          }
          .srv-mob-col.is-active .srv-mob-num {
            color: #F1B541;
          }
          .srv-mob-col.is-active .srv-mob-title {
            color: #ffffff;
          }
        </style>
        ...
        <div class="hidden lg:flex gap-0 overflow-hidden relative border-y border-white/[0.08]" id="srv-cols" style="height: calc(100vh - 80px); min-height: 600px;">
          ...
          <div class="srv-col is-active relative overflow-hidden cursor-pointer min-w-0 border-r border-white/[0.08] bg-[#090b0e]"
            ...
            <img src="assets/img/Servicios/caldereria-industrial.jpeg"
                 ...
                 class="srv-col-bg-img absolute inset-0 w-full h-full object-cover object-center pointer-events-none z-[1]"
                 loading="eager">
            ...
            <div class="srv-col-content absolute inset-0 p-8 sm:p-12 lg:p-16 flex flex-col justify-center overflow-y-auto z-[30]"
              ...
              <div class="max-w-3xl w-full space-y-6 relative z-10">
                ...
                <p class="text-sm sm:text-base text-neutral-300 font-sans leading-relaxed max-w-2xl">
                ...
                <div class="pt-4 flex items-center gap-3">
                  <span class="w-2 h-2 rounded-full bg-brand-yellow"></span>
                  <span class="font-mono text-xs text-neutral-400 uppercase tracking-widest">Torrent &bull; Valencia &bull; Capacidad hasta 20 Tn</span>
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="srv-col is-compressed relative overflow-hidden cursor-pointer min-w-0 border-r border-white/[0.08] bg-[#090b0e]"
            ...
            <div class="srv-col-content absolute inset-0 p-8 sm:p-12 lg:p-16 flex flex-col justify-center overflow-y-auto z-[30]"
              ...
              <div class="max-w-3xl w-full space-y-6 relative z-10">
                ...
                <div class="pt-4 flex items-center gap-3">
                  <span class="w-2 h-2 rounded-full bg-brand-yellow"></span>
                  <span class="font-mono text-xs text-neutral-400 uppercase tracking-widest">Tolerancia &plusmn;0,3 mm &bull; Mesa 9.000 &times; 2.500 mm</span>
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="srv-col is-compressed relative overflow-hidden cursor-pointer min-w-0 border-r border-white/[0.08] bg-[#090b0e]"
            ...
            <div class="srv-col-content absolute inset-0 p-8 sm:p-12 lg:p-16 flex flex-col justify-center overflow-y-auto z-[30]"
              ...
              <div class="max-w-3xl w-full space-y-6 relative z-10">
                ...
                <div class="pt-4 flex items-center gap-3">
                  <span class="w-2 h-2 rounded-full bg-brand-yellow"></span>
                  <span class="font-mono text-xs text-neutral-400 uppercase tracking-widest">EN ISO 15614 &bull; EN 15085-2 &bull; Homologación Oficial</span>
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="srv-col is-compressed relative overflow-hidden cursor-pointer min-w-0 border-r border-white/[0.08] bg-[#090b0e]"
            ...
            <div class="srv-col-content absolute inset-0 p-8 sm:p-12 lg:p-16 flex flex-col justify-center overflow-y-auto z-[30]"
              ...
              <div class="max-w-3xl w-full space-y-6 relative z-10">
                ...
                <div class="pt-4 flex items-center gap-3">
                  <span class="w-2 h-2 rounded-full bg-brand-yellow"></span>
                  <span class="font-mono text-xs text-neutral-400 uppercase tracking-widest">Marcado CE EN 1090-1 &bull; Clases EXC2 y EXC3</span>
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="srv-col is-compressed relative overflow-hidden cursor-pointer min-w-0 bg-[#090b0e]"
            ...
            <div class="srv-col-content absolute inset-0 p-8 sm:p-12 lg:p-16 flex flex-col justify-center overflow-y-auto z-[30]"
              ...
              <div class="max-w-3xl w-full space-y-6 relative z-10">
                ...
                <div class="pt-4 flex items-center gap-3">
                  <span class="w-2 h-2 rounded-full bg-brand-yellow"></span>
                  <span class="font-mono text-xs text-neutral-400 uppercase tracking-widest">Montaje en Obra Civil &bull; Cobertura Nacional</span>
                </div>
              </div>
            </div>
          </div>
        ...
        <div class="flex flex-col lg:hidden overflow-hidden border-y border-white/[0.08]" id="srv-cols-mob" style="height: calc(100vh - 80px); min-height: 560px;">
          ...
          <div class="srv-mob-col is-active relative overflow-hidden cursor-pointer border-b border-white/[0.08] bg-[#090b0e] flex flex-col min-h-0" data-idx="0" style="flex: 1 1 0%;">
            ...
            <div class="srv-mob-body flex-1 overflow-y-auto flex flex-col bg-[#090b0e]">
              <!-- Imagen arriba con espacio visible y degradado a negro a mitad -->
              <div class="relative w-full h-40 sm:h-48 shrink-0 overflow-hidden bg-[#07080a]">
                <img src="assets/img/Servicios/caldereria-industrial.jpeg"
                     alt="Calderería Industrial Solycal"
                     class="w-full h-full object-cover object-center"
                     loading="eager">
                <div class="absolute inset-0 pointer-events-none"
                     style="background: linear-gradient(180deg, transparent 0%, transparent 35%, rgba(9,11,14,0.65) 70%, #090b0e 100%);"></div>
              </div>

              <!-- Textos abajo sobre fondo negro -->
              <div class="px-5 pb-6 pt-3 space-y-3 bg-[#090b0e] flex-1 flex flex-col justify-between">
                <div class="space-y-3">
                ...
                <div class="pt-3 pb-1 flex items-center gap-2">
                  <span class="w-1.5 h-1.5 rounded-full bg-brand-yellow/60"></span>
                  <span class="font-mono text-[10px] text-neutral-400 uppercase tracking-widest">Torrent &bull; Valencia &bull; Capacidad hasta 20 Tn</span>
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="srv-mob-col is-compressed relative overflow-hidden cursor-pointer border-b border-white/[0.08] bg-[#090b0e] flex flex-col min-h-0" data-idx="1" style="flex: 0 0 56px;">
            ...
            <div class="srv-mob-body flex-1 overflow-y-auto flex flex-col bg-[#090b0e]">
              ...
              <div class="px-5 pb-6 pt-3 space-y-3 bg-[#090b0e] flex-1 flex flex-col justify-between">
                ...
                <div class="pt-3 pb-1 flex items-center gap-2">
                  <span class="w-1.5 h-1.5 rounded-full bg-brand-yellow/60"></span>
                  <span class="font-mono text-[10px] text-neutral-400 uppercase tracking-widest">Tolerancia &plusmn;0,3 mm &bull; Mesa 9.000 &times; 2.500 mm</span>
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="srv-mob-col is-compressed relative overflow-hidden cursor-pointer border-b border-white/[0.08] bg-[#090b0e] flex flex-col min-h-0" data-idx="2" style="flex: 0 0 56px;">
            ...
            <div class="srv-mob-body flex-1 overflow-y-auto flex flex-col bg-[#090b0e]">
              ...
              <div class="relative w-full h-40 sm:h-48 shrink-0 overflow-hidden bg-[#07080a]">
                <img src="assets/img/Servicios/soldadura-tecnica.jpeg"
                     alt="Soldadura Técnica Homologada"
                     class="w-full h-full object-cover object-center"
                     loading="lazy">
                <div class="absolute inset-0 pointer-events-none"
                     style="background: linear-gradient(180deg, transparent 0%, transparent 35%, rgba(9,11,14,0.65) 70%, #090b0e 100%);"></div>
              ...
              <div class="px-5 pb-6 pt-3 space-y-3 bg-[#090b0e] flex-1 flex flex-col justify-between">
                ...
                <div class="pt-3 pb-1 flex items-center gap-2">
                  <span class="w-1.5 h-1.5 rounded-full bg-brand-yellow/60"></span>
                  <span class="font-mono text-[10px] text-neutral-400 uppercase tracking-widest">EN ISO 15614 &bull; EN 15085-2 &bull; Homologación Oficial</span>
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="srv-mob-col is-compressed relative overflow-hidden cursor-pointer border-b border-white/[0.08] bg-[#090b0e] flex flex-col min-h-0" data-idx="3" style="flex: 0 0 56px;">
            ...
            <div class="srv-mob-body flex-1 overflow-y-auto flex flex-col bg-[#090b0e]">
              ...
              <div class="px-5 pb-6 pt-3 space-y-3 bg-[#090b0e] flex-1 flex flex-col justify-between">
                ...
                <div class="pt-3 pb-1 flex items-center gap-2">
                  <span class="w-1.5 h-1.5 rounded-full bg-brand-yellow/60"></span>
                  <span class="font-mono text-[10px] text-neutral-400 uppercase tracking-widest">Marcado CE EN 1090-1 &bull; Clases EXC2/EXC3</span>
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="srv-mob-col is-compressed relative overflow-hidden cursor-pointer bg-[#090b0e] flex flex-col min-h-0" data-idx="4" style="flex: 0 0 56px;">
            ...
            <div class="srv-mob-body flex-1 overflow-y-auto flex flex-col bg-[#090b0e]">
              ...
              <div class="px-5 pb-6 pt-3 space-y-3 bg-[#090b0e] flex-1 flex flex-col justify-between">
                ...
                <div class="pt-3 pb-1 flex items-center gap-2">
                  <span class="w-1.5 h-1.5 rounded-full bg-brand-yellow/60"></span>
                  <span class="font-mono text-[10px] text-neutral-400 uppercase tracking-widest">Montaje en Obra Civil &bull; Cobertura Nacional</span>
                </div>
              </div>
            </div>
          </div>
    ...
    (function(){
      ...
      function activateCol(idx, isInitial){
        if(idx === activeIdx && !isInitial) return;
        ...
        cols.forEach(function(col, i){
          ...
          var bgImg = col.querySelector('.srv-col-bg-img');
          ...
          if(i === idx){
            ...
            if(isInitial){
              gsap.set(col, { flexGrow: 21, flexShrink: 1, flexBasis: '0%' });
              if(bar) gsap.set(bar, { scaleX: 1, transformOrigin: 'left' });
              if(bgImg) gsap.set(bgImg, { opacity: 0.85, scale: 1 });
            ...
            if(isInitial){
              gsap.set(col, { flexGrow: 1, flexShrink: 1, flexBasis: '0%' });
              if(bar) gsap.set(bar, { scaleX: 0, transformOrigin: 'left' });
              if(bgImg) gsap.set(bgImg, { opacity: 0.30, scale: 1.06 });
      ...
      if(cols.length) activateCol(0, true);
      ...
      function activateMobCol(idx, isInitial){
        if(idx === activeMobIdx && !isInitial) return;

        mobCols.forEach(function(col, i){
          var bar = col.querySelector('.srv-mob-bar');
          var arr = col.querySelector('.srv-mob-arr');
          var body = col.querySelector('.srv-mob-body');
          ...
          if(i === idx){
            ...
            if(isInitial){
              gsap.set(col, { flexGrow: 1, flexShrink: 1, flexBasis: '0%' });
              if(bar) gsap.set(bar, { scaleY: 1, transformOrigin: 'top' });
            ...
            if(isInitial){
              gsap.set(col, { flexGrow: 0, flexShrink: 0, flexBasis: '56px' });
              if(bar) gsap.set(bar, { scaleY: 0, transformOrigin: 'top' });
      ...
      if(mobCols.length) activateMobCol(0, true);
