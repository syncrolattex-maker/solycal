          ...
          <div class="srv-col relative overflow-hidden cursor-pointer flex-shrink-0 border border-brand-border rounded-xl transition-all duration-700 ease-[cubic-bezier(0.16,1,0.3,1)]"
            ...
            <div class="srv-col-label absolute inset-0 flex items-end justify-start p-6 transition-opacity duration-300">
              <div class="flex items-center gap-3">
                ...
                <span class="font-mono text-xs text-white/50 uppercase tracking-widest" style="writing-mode: vertical-rl; transform: rotate(180deg);">Calderería Industrial</span>
              </div>
            </div>
            <!-- Expanded content — clip reveal top to bottom -->
            <div class="srv-col-content absolute inset-0 p-8 flex flex-col justify-end opacity-0 transition-opacity duration-500"
              ...
              <h3 class="text-2xl font-display font-bold text-white tracking-tight mb-4 leading-tight">Calderería Industrial<br>Pesada &amp; Ligera</h3>
            ...
            <div class="srv-col-bg absolute inset-0 bg-brand-dark opacity-0 transition-opacity duration-500 pointer-events-none"></div>
          </div>
          ...
          <div class="srv-col relative overflow-hidden cursor-pointer flex-shrink-0 border border-brand-border rounded-xl transition-all duration-700 ease-[cubic-bezier(0.16,1,0.3,1)]"
            ...
            <div class="srv-col-label absolute inset-0 flex items-end justify-start p-6 transition-opacity duration-300">
              <div class="flex items-center gap-3">
                ...
                <span class="font-mono text-xs text-white/50 uppercase tracking-widest" style="writing-mode: vertical-rl; transform: rotate(180deg);">Corte Plasma HD</span>
              </div>
            </div>
            <div class="srv-col-content absolute inset-0 p-8 flex flex-col justify-end opacity-0 transition-opacity duration-500"
                 style="clip-path: inset(0 0 100% 0); transition: clip-path 0.6s cubic-bezier(0.16,1,0.3,1), opacity 0.3s ease;">
              <span class="font-mono text-[11px] text-brand-yellow uppercase tracking-widest block mb-3">02 // TECNOLOGÍA HYPERTHERM</span>
              <h3 class="text-2xl font-display font-bold text-white tracking-tight mb-4 leading-tight">Corte Plasma HD<br>TrueHole</h3>
          ...
          <div class="srv-col relative overflow-hidden cursor-pointer flex-shrink-0 border border-brand-border rounded-xl transition-all duration-700 ease-[cubic-bezier(0.16,1,0.3,1)]"
            ...
            <div class="srv-col-label absolute inset-0 flex items-end justify-start p-6 transition-opacity duration-300">
              <div class="flex items-center gap-3">
                ...
                <span class="font-mono text-xs text-white/50 uppercase tracking-widest" style="writing-mode: vertical-rl; transform: rotate(180deg);">Soldadura TIG/MIG</span>
              </div>
            </div>
            <div class="srv-col-content absolute inset-0 p-8 flex flex-col justify-end opacity-0 transition-opacity duration-500"
                 style="clip-path: inset(0 0 100% 0); transition: clip-path 0.6s cubic-bezier(0.16,1,0.3,1), opacity 0.3s ease;">
              <span class="font-mono text-[11px] text-brand-yellow uppercase tracking-widest block mb-3">03 // HOMOLOGACIONES OFICIALES</span>
              <h3 class="text-2xl font-display font-bold text-white tracking-tight mb-4 leading-tight">Soldadura Técnica<br>Homologada</h3>
          ...
          <div class="srv-col relative overflow-hidden cursor-pointer flex-shrink-0 border border-brand-border rounded-xl transition-all duration-700 ease-[cubic-bezier(0.16,1,0.3,1)]"
            ...
            <div class="srv-col-label absolute inset-0 flex items-end justify-start p-6 transition-opacity duration-300">
              <div class="flex items-center gap-3">
                ...
                <span class="font-mono text-xs text-white/50 uppercase tracking-widest" style="writing-mode: vertical-rl; transform: rotate(180deg);">Estructuras CE</span>
              </div>
            </div>
            <div class="srv-col-content absolute inset-0 p-8 flex flex-col justify-end opacity-0 transition-opacity duration-500"
                 style="clip-path: inset(0 0 100% 0); transition: clip-path 0.6s cubic-bezier(0.16,1,0.3,1), opacity 0.3s ease;">
              <span class="font-mono text-[11px] text-brand-yellow uppercase tracking-widest block mb-3">04 // MARCADO CE EN 1090-1</span>
              <h3 class="text-2xl font-display font-bold text-white tracking-tight mb-4 leading-tight">Estructuras Metálicas<br>&amp; Pasarelas CE</h3>
          ...
          <div class="srv-col relative overflow-hidden cursor-pointer flex-shrink-0 border border-brand-border rounded-xl transition-all duration-700 ease-[cubic-bezier(0.16,1,0.3,1)]"
            ...
            <div class="srv-col-label absolute inset-0 flex items-end justify-start p-6 transition-opacity duration-300">
              <div class="flex items-center gap-3">
                ...
                <span class="font-mono text-xs text-white/50 uppercase tracking-widest" style="writing-mode: vertical-rl; transform: rotate(180deg);">Montaje en Obra</span>
              </div>
            </div>
            <div class="srv-col-content absolute inset-0 p-8 flex flex-col justify-end opacity-0 transition-opacity duration-500"
                 style="clip-path: inset(0 0 100% 0); transition: clip-path 0.6s cubic-bezier(0.16,1,0.3,1), opacity 0.3s ease;">
              <span class="font-mono text-[11px] text-brand-yellow uppercase tracking-widest block mb-3">05 // INSTALACIÓN EN PLANTA</span>
              <h3 class="text-2xl font-display font-bold text-white tracking-tight mb-4 leading-tight">Montaje e Instalación<br>en Obra Civil</h3>
    ...
    (function(){
      ...
      function activateCol(idx){
        cols.forEach(function(col, i){
          ...
          var bg      = col.querySelector('.srv-col-bg');
          if(i === idx){
