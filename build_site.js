...
<head>
  ...
  <style>
    ...
    #solycal-loader {
      ...
      justify-content: center;
      overflow: hidden;
      transition: opacity 0.5s cubic-bezier(0.65, 0, 0.35, 1), visibility 0.5s ease;
    }
...
function getHeader(activeSlug) {
  ...
  <div id="solycal-loader" aria-hidden="false">
    <div class="loader-brand-container">
      <!-- Icono Logo 'S' de Solycal (Aparece en el centro y se mueve a la izquierda) -->
      <img id="loader-logo-icon" src="assets/logo-icon.png" alt="Solycal" class="w-14 sm:w-20 md:w-24 h-auto object-contain flex-shrink-0">

      <!-- Contenedor del texto SOLYCAL con letras individuales para animación progresiva a modo de carga -->
      <div id="loader-logo-text-wrap" class="overflow-hidden flex items-center ml-0 pl-0">
        <div id="loader-letters" class="font-display font-bold text-3xl sm:text-5xl md:text-6xl tracking-wider text-white flex items-center">
  ...
  <script>
    ...
    window.addEventListener('DOMContentLoaded', () => {
      ...
      if (typeof gsap !== 'undefined') {
        ...
        // Función para lanzar la web (entrada de hero y secciones)
        ...
        if (solycalLoader && !hasLoadedBefore) {
          ...
          // 1. Estado Inicial:
          // La 'S' se coloca perfectamente en el centro geométrico de la pantalla
          gsap.set(loaderIcon, { 
            opacity: 0, 
            scale: 0.4,
            xPercent: 0,
          ...
          // El contenedor de texto empieza replegado
          ...
          // Cada una de las letras SOLYCAL ocultas preparadas para la carga
          ...
          const loadTl = gsap.timeline({
            onComplete: () => {
              // Una vez completada la animación de SOLYCAL, se lanza la web
          ...
          loadTl
            // PASO 1: Aparece el logo 'S' en el centro de la pantalla con impacto
            .to(loaderIcon, {
              opacity: 1,
              scale: 1,
              duration: 0.75,
            ...
            // Pequeña pausa dramática para apreciar el logo
            .to({}, { duration: 0.25 })

            // PASO 2: La 'S' se aparta fluidamente a la izquierda
            // mientras se abre el espacio para el texto SOLYCAL
            ...
            // PASO 3: Aparecen a modo de carga las letras S - O - L - Y - C - A - L
            // Una a una secuencialmente con ritmo constante y preciso de carga técnica
            .to(loaderChars, {
              opacity: 1,
              y: 0,
              scale: 1,
              stagger: 0.11, // Cada letra entra como paso de carga
              duration: 0.4,
              ease: "back.out(2)"
            }, "-=0.25")

            // Ligero pulso final al completar todas las letras antes de lanzar la web
            .to(loaderIcon, {
              filter: "drop-shadow(0 0 15px rgba(241,181,65,0.8))",
              duration: 0.3,
              ease: "power2.out"
            }, "+=0.15");
