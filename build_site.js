    ...
    window.addEventListener('DOMContentLoaded', () => {
      ...
      if (typeof gsap !== 'undefined') {
        ...
        if (solycalLoader && !hasLoadedBefore) {
          ...
          // 1. Estado Inicial:
          // La 'S' se coloca centrada limpia sin sombras
          gsap.set(loaderIcon, { 
            opacity: 0, 
            scale: 0.6,
            filter: "none"
          ...
          // Cada una de las letras SOLYCAL preparadas para una aparición fluida y suave
          ...
          const loadTl = gsap.timeline({
            onComplete: () => {
              // Lanzamiento suave y limpio de la web sin saltos ni sombras
          ...
          loadTl
            // PASO 1: Aparece el logo 'S' en el centro con fade y escala suave y orgánica
            .to(loaderIcon, {
              opacity: 1,
              scale: 1,
              duration: 0.7,
            ...
            // Pausa breve equilibrada
            .to({}, { duration: 0.2 })

            // PASO 2: La 'S' se aparta suavemente (smooth) a la izquierda
            ...
            // PASO 3: Aparición muy fluida (smooth) de las letras SOLYCAL
            // Flujo progresivo natural y continuo a modo de carga
            .to(loaderChars, {
              opacity: 1,
              x: 0,
              stagger: 0.08, // Transición suave entre cada letra
              duration: 0.5,
              ease: "power2.out"
            }, "-=0.35")

            // Breve pausa para apreciar la palabra completa limpia y sin ninguna sombra dorada
            .to({}, { duration: 0.35 });
