      ...
      <div class="w-full px-6 sm:px-12 lg:px-20 py-8 flex-1 flex flex-col justify-center">
        <div class="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
          ...
          <div class="lg:col-span-5 space-y-8 border-t lg:border-t-0 lg:border-l border-white/10 pt-8 lg:pt-0 lg:pl-12">
            ...
            <!-- Redes Sociales Oficiales Solycal (solycal.es) -->
            <div>
              <p class="font-mono text-xs text-brand-yellow uppercase tracking-widest mb-3">// REDES SOCIALES</p>
              <div class="flex flex-wrap gap-2.5">
                <a href="https://www.linkedin.com/company/solycal/" target="_blank" rel="noopener noreferrer" class="px-3.5 py-2 rounded-lg bg-white/5 border border-white/10 hover:border-brand-yellow/40 hover:bg-white/10 text-white hover:text-brand-yellow font-mono text-xs inline-flex items-center gap-2 transition-all group">
                  <i data-lucide="linkedin" class="w-3.5 h-3.5 text-brand-yellow group-hover:scale-110 transition-transform"></i>
                  <span>LinkedIn</span>
                </a>
                <a href="https://www.instagram.com/solycal_/" target="_blank" rel="noopener noreferrer" class="px-3.5 py-2 rounded-lg bg-white/5 border border-white/10 hover:border-brand-yellow/40 hover:bg-white/10 text-white hover:text-brand-yellow font-mono text-xs inline-flex items-center gap-2 transition-all group">
                  <i data-lucide="instagram" class="w-3.5 h-3.5 text-brand-yellow group-hover:scale-110 transition-transform"></i>
                  <span>Instagram</span>
                </a>
                <a href="https://www.facebook.com/solycal" target="_blank" rel="noopener noreferrer" class="px-3.5 py-2 rounded-lg bg-white/5 border border-white/10 hover:border-brand-yellow/40 hover:bg-white/10 text-white hover:text-brand-yellow font-mono text-xs inline-flex items-center gap-2 transition-all group">
                  <i data-lucide="facebook" class="w-3.5 h-3.5 text-brand-yellow group-hover:scale-110 transition-transform"></i>
                  <span>Facebook</span>
                </a>
                <a href="https://www.youtube.com/channel/UC4_Yk1tJqoAFrBOQ-fi4T7w" target="_blank" rel="noopener noreferrer" class="px-3.5 py-2 rounded-lg bg-white/5 border border-white/10 hover:border-brand-yellow/40 hover:bg-white/10 text-white hover:text-brand-yellow font-mono text-xs inline-flex items-center gap-2 transition-all group">
                  <i data-lucide="youtube" class="w-3.5 h-3.5 text-brand-yellow group-hover:scale-110 transition-transform"></i>
                  <span>YouTube</span>
                </a>
              </div>
            </div>
