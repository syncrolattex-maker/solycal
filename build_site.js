...
<div id="services-page-container" class="relative bg-[#07080a] overflow-hidden">
  ...
  <div class="relative z-10">
    ...
    <!-- 02 CATEGORIES ACCORDION — SERVICIOS INDUSTRIALES (Ripplix AWE Style) -->
    <section class="py-20 sm:py-28 relative" id="services-accordion-section">
      ...
      <div class="w-full px-6 mb-16">
        <div class="flex flex-col sm:flex-row sm:items-end sm:justify-between gap-4">
          <div>
            ...
            <h2 class="text-3xl sm:text-5xl font-display font-bold text-white tracking-tight leading-tight max-w-xl">
      ...
      <div class="w-full px-6">
        <div class="flex flex-col lg:flex-row gap-0 lg:gap-8 items-start">
          
          <!-- LEFT: Accordion list -->
          <div class="w-full lg:w-1/2 xl:w-5/12 order-2 lg:order-1" id="srv-accordion">

            <!-- Item 01: Calderería -->
            <div class="srv-item group border-t border-white/10 cursor-pointer" data-srv="caldereria" data-img="assets/power2.png" data-alt="Calderería industrial pesada y ligera">
              <div class="flex items-start justify-between gap-4 py-6 sm:py-8 transition-all duration-300">
                <div class="flex items-start gap-5 min-w-0">
                  <span class="font-mono text-xs text-brand-yellow/60 shrink-0 mt-1 w-6">01</span>
                  <div class="min-w-0">
                    <h3 class="text-xl sm:text-2xl font-display font-bold text-white group-hover:text-brand-yellow transition-colors duration-300 tracking-tight">Calderería Industrial</h3>
                    <!-- Expandable content -->
                    <div class="srv-body overflow-hidden transition-all duration-500 ease-in-out max-h-0 opacity-0">
                      <p class="text-sm text-neutral-400 font-sans leading-relaxed mt-4 mb-4">
                        Tolvas, silos, ciclones, depósitos bajo presión y conductos de aspiración. Curvado hasta 2.000 × 12 mm. Plegado CNC Ermaksan 4 m. Acero al carbono, inoxidable y aleaciones.
                      </p>
                      <ul class="font-mono text-xs text-brand-textMuted space-y-1.5 mb-5">
                        <li class="flex items-center gap-2"><span class="w-1 h-1 bg-brand-yellow rounded-full shrink-0"></span>Curvado de chapa hasta 12 mm de espesor</li>
                        <li class="flex items-center gap-2"><span class="w-1 h-1 bg-brand-yellow rounded-full shrink-0"></span>Plegado CNC con máquina Ermaksan de 4 m</li>
                        <li class="flex items-center gap-2"><span class="w-1 h-1 bg-brand-yellow rounded-full shrink-0"></span>Fabricación de depósitos y vasijas de presión</li>
                      </ul>
                      <a href="contacto.html" class="inline-flex items-center gap-1.5 font-mono text-xs text-brand-yellow hover:underline">
                ...
                <!-- Chevron -->
                <div class="srv-chevron shrink-0 mt-1 w-5 h-5 text-white/30 group-hover:text-brand-yellow transition-all duration-300">
                  <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="w-full h-full transition-transform duration-300"><path d="m6 9 6 6 6-6"/></svg>
                </div>
              </div>
            </div>

            <!-- Item 02: Corte Plasma -->
            <div class="srv-item group border-t border-white/10 cursor-pointer" data-srv="plasma" data-img="assets/corte-plasma.jpg" data-alt="Corte plasma HD Hypertherm TrueHole">
              <div class="flex items-start justify-between gap-4 py-6 sm:py-8 transition-all duration-300">
                <div class="flex items-start gap-5 min-w-0">
                  <span class="font-mono text-xs text-brand-yellow/60 shrink-0 mt-1 w-6">02</span>
                  <div class="min-w-0">
                    <h3 class="text-xl sm:text-2xl font-display font-bold text-white group-hover:text-brand-yellow transition-colors duration-300 tracking-tight">Corte Plasma HD TrueHole</h3>
                    <div class="srv-body overflow-hidden transition-all duration-500 ease-in-out max-h-0 opacity-0">
                      <p class="text-sm text-neutral-400 font-sans leading-relaxed mt-4 mb-4">
                        Pórtico CNC 9.000 × 2.500 mm. Fuente Hypertherm HPR260XD. Corte hasta 50 mm en acero al carbono y 15 mm en inoxidable. Software de nesting para optimizar material.
                      </p>
                      <ul class="font-mono text-xs text-brand-textMuted space-y-1.5 mb-5">
                        <li class="flex items-center gap-2"><span class="w-1 h-1 bg-brand-yellow rounded-full shrink-0"></span>Tolerancias de ±0,3 mm en taladros TrueHole</li>
                        <li class="flex items-center gap-2"><span class="w-1 h-1 bg-brand-yellow rounded-full shrink-0"></span>Corte de aluminio hasta 25 mm</li>
                        <li class="flex items-center gap-2"><span class="w-1 h-1 bg-brand-yellow rounded-full shrink-0"></span>Marcado e identificación automática de piezas</li>
                      </ul>
                      <a href="contacto.html" class="inline-flex items-center gap-1.5 font-mono text-xs text-brand-yellow hover:underline">
                        Pedir presupuesto de corte
                        <svg class="w-3 h-3" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><path d="M5 12h14"/><path d="m12 5 7 7-7 7"/></svg>
                      </a>
                    </div>
                  </div>
            ...
            <!-- Item 03: Soldadura -->
            <div class="srv-item group border-t border-white/10 cursor-pointer" data-srv="soldadura" data-img="assets/soldadura.jpg" data-alt="Soldadura homologada TIG MIG en acero inoxidable">
              <div class="flex items-start justify-between gap-4 py-6 sm:py-8 transition-all duration-300">
                <div class="flex items-start gap-5 min-w-0">
                  <span class="font-mono text-xs text-brand-yellow/60 shrink-0 mt-1 w-6">03</span>
                  <div class="min-w-0">
                    <h3 class="text-xl sm:text-2xl font-display font-bold text-white group-hover:text-brand-yellow transition-colors duration-300 tracking-tight">Soldadura Homologada TIG / MIG</h3>
                    <div class="srv-body overflow-hidden transition-all duration-500 ease-in-out max-h-0 opacity-0">
                      <p class="text-sm text-neutral-400 font-sans leading-relaxed mt-4 mb-4">
                        Equipo de soldadores homologados bajo normativas europeas. Procedimientos TIG, MIG-MAG y Arco Sumergido. Certificación ferroviaria EN 15085-2. Especialistas en inoxidable y aluminio.
                      </p>
                      <ul class="font-mono text-xs text-brand-textMuted space-y-1.5 mb-5">
                        <li class="flex items-center gap-2"><span class="w-1 h-1 bg-brand-yellow rounded-full shrink-0"></span>Homologaciones EN ISO 15614 activas</li>
                        <li class="flex items-center gap-2"><span class="w-1 h-1 bg-brand-yellow rounded-full shrink-0"></span>Control dimensional y ensayos no destructivos</li>
                        <li class="flex items-center gap-2"><span class="w-1 h-1 bg-brand-yellow rounded-full shrink-0"></span>Certificación ferroviaria EN 15085-2</li>
                      </ul>
                      <a href="calidad.html" class="inline-flex items-center gap-1.5 font-mono text-xs text-brand-yellow hover:underline">
                        Ver certificaciones
                        <svg class="w-3 h-3" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><path d="M5 12h14"/><path d="m12 5 7 7-7 7"/></svg>
                      </a>
                    </div>
            ...
            <!-- Item 04: Estructuras -->
            <div class="srv-item group border-t border-white/10 cursor-pointer" data-srv="estructuras" data-img="assets/estructuras.jpg" data-alt="Estructuras metálicas y pasarelas industriales marcado CE">
              <div class="flex items-start justify-between gap-4 py-6 sm:py-8 transition-all duration-300">
                <div class="flex items-start gap-5 min-w-0">
                  <span class="font-mono text-xs text-brand-yellow/60 shrink-0 mt-1 w-6">04</span>
                  <div class="min-w-0">
                    <h3 class="text-xl sm:text-2xl font-display font-bold text-white group-hover:text-brand-yellow transition-colors duration-300 tracking-tight">Estructuras Metálicas &amp; Pasarelas</h3>
                    <div class="srv-body overflow-hidden transition-all duration-500 ease-in-out max-h-0 opacity-0">
                      <p class="text-sm text-neutral-400 font-sans leading-relaxed mt-4 mb-4">
                        Fabricación de estructuras portantes, pasarelas de acceso, bancadas de maquinaria y líneas de vida con marcado CE obligatorio EN 1090-1. Montaje en obra por personal propio.
                      </p>
                      <ul class="font-mono text-xs text-brand-textMuted space-y-1.5 mb-5">
                        <li class="flex items-center gap-2"><span class="w-1 h-1 bg-brand-yellow rounded-full shrink-0"></span>Marcado CE EXC2 y EXC3 disponible</li>
                        <li class="flex items-center gap-2"><span class="w-1 h-1 bg-brand-yellow rounded-full shrink-0"></span>Galvanizado, granallado y pintura anticorrosiva C5</li>
                        <li class="flex items-center gap-2"><span class="w-1 h-1 bg-brand-yellow rounded-full shrink-0"></span>Montaje y replanteo en obra civil</li>
                      </ul>
                      <a href="contacto.html" class="inline-flex items-center gap-1.5 font-mono text-xs text-brand-yellow hover:underline">
                        Solicitar valoración estructural
                        <svg class="w-3 h-3" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><path d="M5 12h14"/><path d="m12 5 7 7-7 7"/></svg>
                      </a>
                    </div>
                  </div>
            ...
            <!-- Item 05: Montaje en Obra -->
            <div class="srv-item group border-t border-b border-white/10 cursor-pointer" data-srv="montaje" data-img="assets/power2.png" data-alt="Montaje industrial en obra civil con puente grúa">
              <div class="flex items-start justify-between gap-4 py-6 sm:py-8 transition-all duration-300">
                <div class="flex items-start gap-5 min-w-0">
                  <span class="font-mono text-xs text-brand-yellow/60 shrink-0 mt-1 w-6">05</span>
                  <div class="min-w-0">
                    <h3 class="text-xl sm:text-2xl font-display font-bold text-white group-hover:text-brand-yellow transition-colors duration-300 tracking-tight">Montaje en Obra Civil</h3>
                    <div class="srv-body overflow-hidden transition-all duration-500 ease-in-out max-h-0 opacity-0">
                      <p class="text-sm text-neutral-400 font-sans leading-relaxed mt-4 mb-4">
                        Servicio completo de instalación en planta con personal propio. Coordinamos el transporte especial, el izado con medios auxiliares y el replanteo geométrico de cada conjunto fabricado.
                      </p>
                      <ul class="font-mono text-xs text-brand-textMuted space-y-1.5 mb-5">
                        <li class="flex items-center gap-2"><span class="w-1 h-1 bg-brand-yellow rounded-full shrink-0"></span>Transporte especial de piezas sobredimensionadas</li>
                        <li class="flex items-center gap-2"><span class="w-1 h-1 bg-brand-yellow rounded-full shrink-0"></span>Coordinación con obra civil y otras industrias</li>
                        <li class="flex items-center gap-2"><span class="w-1 h-1 bg-brand-yellow rounded-full shrink-0"></span>Pruebas de presión y estanqueidad en campo</li>
                      </ul>
                      <a href="contacto.html" class="inline-flex items-center gap-1.5 font-mono text-xs text-brand-yellow hover:underline">
                        Consultar proyecto de montaje
                        <svg class="w-3 h-3" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><path d="M5 12h14"/><path d="m12 5 7 7-7 7"/></svg>
                      </a>
                    </div>
                  </div>
          ...
          <!-- RIGHT: Sticky image reveal panel (hidden on mobile) -->
          <div class="hidden lg:block w-full lg:w-1/2 xl:w-7/12 order-1 lg:order-2 lg:sticky lg:top-28 self-start" id="srv-image-panel">
            <div class="relative w-full aspect-[4/3] rounded-2xl overflow-hidden bg-brand-dark border border-brand-border">
              <!-- Image display -->
              <img id="srv-active-img"
                src="assets/power2.png"
                alt="Servicio activo Solycal"
              ...
              <div class="absolute bottom-0 left-0 right-0 p-6 pointer-events-none">
                <span id="srv-active-label" class="font-mono text-xs text-brand-yellow uppercase tracking-widest opacity-0 transition-opacity duration-300 block"></span>
                <p id="srv-active-title" class="font-display text-white font-bold text-2xl mt-1 opacity-0 transition-opacity duration-300"></p>
              </div>
              <!-- Decorative corners -->
              <div class="absolute top-4 left-4 w-6 h-6 border-t-2 border-l-2 border-brand-yellow/40 pointer-events-none"></div>
              <div class="absolute bottom-4 right-4 w-6 h-6 border-b-2 border-r-2 border-brand-yellow/40 pointer-events-none"></div>
            </div>
            <!-- Tech specs strip below image -->
            <div class="mt-4 grid grid-cols-3 gap-3">
              <div class="p-4 rounded-xl bg-brand-dark border border-brand-border text-center">
                <span class="font-mono text-brand-yellow font-bold text-lg block">5.000</span>
                <span class="font-mono text-brand-textMuted text-xs uppercase tracking-widest">m² taller</span>
              </div>
              <div class="p-4 rounded-xl bg-brand-dark border border-brand-border text-center">
                <span class="font-mono text-brand-yellow font-bold text-lg block">16 Tn</span>
                <span class="font-mono text-brand-textMuted text-xs uppercase tracking-widest">puente grúa</span>
              </div>
              <div class="p-4 rounded-xl bg-brand-dark border border-brand-border text-center">
                <span class="font-mono text-brand-yellow font-bold text-lg block">ISO</span>
                <span class="font-mono text-brand-textMuted text-xs uppercase tracking-widest">9001 · 1090</span>
              </div>
            </div>
          </div>
    ...
    <script>
      (function() {
        ...
        const activeImg = document.getElementById('srv-active-img');
        const activeLabel = document.getElementById('srv-active-label');
        const activeTitle = document.getElementById('srv-active-title');
        let currentOpen = null;
        let imgTimeout = null;

        const serviceLabels = {
          caldereria: '01 // TRANSFORMACIÓN DE CHAPA',
          plasma: '02 // TECNOLOGÍA HYPERTHERM',
          soldadura: '03 // HOMOLOGACIONES OFICIALES',
          estructuras: '04 // MARCADO CE EN 1090-1',
          montaje: '05 // INSTALACIÓN EN PLANTA'
        };
        const serviceTitles = {
          caldereria: 'Calderería Industrial',
          plasma: 'Corte Plasma HD',
          soldadura: 'Soldadura Homologada',
          estructuras: 'Estructuras & Pasarelas',
          montaje: 'Montaje en Obra'
        };

        function openItem(item) {
          const body = item.querySelector('.srv-body');
          const chevron = item.querySelector('.srv-chevron svg');
        ...
        function updateImage(imgSrc, imgAlt, srvKey) {
          if (!activeImg) return;
          ...
          imgTimeout = setTimeout(() => {
            ...
            activeImg.alt = imgAlt;
            activeLabel.textContent = serviceLabels[srvKey] || '';
            activeTitle.textContent = serviceTitles[srvKey] || '';
        ...
        items.forEach((item) => {
          item.addEventListener('click', () => {
            ...
            if (isOpen) {
              ...
              openItem(item);
              currentOpen = item;
              updateImage(imgSrc, imgAlt, srvKey);
            }
          });

          // Desktop hover: update image without opening
        ...
        // Open first item by default on desktop, show first image
        if (window.innerWidth >= 1024 && items.length > 0) {
          openItem(items[0]);
          currentOpen = items[0];
          const first = items[0];
          if (activeLabel) activeLabel.textContent = serviceLabels[first.dataset.srv] || '';
          if (activeTitle) activeTitle.textContent = serviceTitles[first.dataset.srv] || '';
