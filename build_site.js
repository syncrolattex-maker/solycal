  ...
  <script>
    ...
    window.addEventListener('DOMContentLoaded', () => {
      ...
      if (typeof gsap !== 'undefined') {
        ...
        // LOGO INTRO ANIMATION (Se reproduce en cada visita o cambio de página):
        ...
        if (logoLink && logoIcon && logoText) {
          // Estado inicial: logo a la izquierda pequeño/invisible, texto oculto
          gsap.set(logoIcon, { 
            opacity: 0, 
            scale: 0.4,
            x: 0
          ...
          logoTl
            // Paso 1: Aparece el logo a la izquierda con impacto y rebote elástico
            .to(logoIcon, { 
              opacity: 1, 
              scale: 1, 
              duration: 0.6, 
            ...
            // Paso 2: A continuación el texto SOLYCAL emerge y se despliega a su derecha
            .to(logoText, { 
              opacity: 1, 
              x: 0, 
              maxWidth: 240, 
        ...
        if (document.querySelector('.hero-sub')) {
          heroTl
            .from('.hero-sub', { opacity: 0, y: -20, duration: 0.8, delay: 0.2 })
