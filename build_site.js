  ...
  <div class="relative z-10">
    ...
    <section id="services-stack-section" class="py-16 sm:py-24 relative">
      ...
      <div class="w-full max-w-6xl mx-auto px-4 sm:px-6 relative">
        ...
        <article id="caldereria" class="stack-card sticky top-[144px] rounded-3xl p-6 sm:p-10 lg:p-12 mb-16 sm:mb-24 bg-[#0a0c0e] border border-white/10 shadow-[0_25px_60px_rgba(0,0,0,0.85)] overflow-hidden transition-all duration-300" data-card-index="0">
        ...
        <article id="plasma" class="stack-card sticky top-[144px] rounded-3xl p-6 sm:p-10 lg:p-12 mb-16 sm:mb-24 bg-[#0a0c0e] border border-white/10 shadow-[0_25px_60px_rgba(0,0,0,0.85)] overflow-hidden transition-all duration-300" data-card-index="1">
          <div class="card-spotlight-layer absolute inset-0 pointer-events-none rounded-3xl" style="background: radial-gradient(650px circle at var(--mouse-x, 50%) var(--mouse-y, 50%), rgba(241,181,65,0.12), transparent 70%);"></div>
        ...
        <article id="soldadura" class="stack-card sticky top-[144px] rounded-3xl p-6 sm:p-10 lg:p-12 mb-16 sm:mb-24 bg-[#0a0c0e] border border-white/10 shadow-[0_25px_60px_rgba(0,0,0,0.85)] overflow-hidden transition-all duration-300" data-card-index="2">
          <div class="card-spotlight-layer absolute inset-0 pointer-events-none rounded-3xl" style="background: radial-gradient(650px circle at var(--mouse-x, 50%) var(--mouse-y, 50%), rgba(241,181,65,0.12), transparent 70%);"></div>
        ...
        <article id="estructuras" class="stack-card sticky top-[144px] rounded-3xl p-6 sm:p-10 lg:p-12 mb-16 sm:mb-24 bg-[#0a0c0e] border border-white/10 shadow-[0_25px_60px_rgba(0,0,0,0.85)] overflow-hidden transition-all duration-300" data-card-index="3">
          <div class="card-spotlight-layer absolute inset-0 pointer-events-none rounded-3xl" style="background: radial-gradient(650px circle at var(--mouse-x, 50%) var(--mouse-y, 50%), rgba(241,181,65,0.12), transparent 70%);"></div>
    ...
    function initServicesInteractiveStack() {
      ...
      navButtons.forEach((btn, idx) => {
        btn.addEventListener('click', () => {
          ...
          if (target) {
            const topOffset = target.getBoundingClientRect().top + window.pageYOffset - 146;
