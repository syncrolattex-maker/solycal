        ...
        const playHeroEntrance = (delay = 0) => {
          if (document.querySelector('.hero-sub')) {
            ...
            heroTl
              ...
              .from('#bg-hero-image', { opacity: 0, scale: 1.18, duration: 1.8, ease: "power2.out" }, 0);
          }
        };
...
<!-- HERO SECTION EDITORIAL & BOLD WITH HIGH-TECH CNC PLASMA CUTTING IMAGE BACKGROUND -->
<section class="min-h-[94vh] flex items-center relative pt-12 pb-24 border-b border-white/5 overflow-hidden">
  <!-- Background Image: Corte Plasma / Láser HD Hypertherm TrueHole (header.jpg) -->
  <div class="absolute inset-0 z-0 overflow-hidden">
    <img 
      id="bg-hero-image"
      src="assets/header.jpg" 
      alt="Corte por plasma y láser térmico de alta definición - SOLYCAL Soldadura y Calderería Valenciana" 
      class="w-full h-full object-cover object-center opacity-65 scale-105 filter brightness-90 contrast-105"
    >
  </div>
  <!-- Dark & Industrial Overlays Full-Width for Optimal Editorial Readability -->
  <div class="absolute inset-0 z-[1] pointer-events-none bg-gradient-to-r from-[#07080a] via-[#07080a]/80 to-[#07080a]/55"></div>
  <div class="absolute inset-0 z-[1] pointer-events-none bg-gradient-to-t from-[#07080a] via-transparent to-[#07080a]/75"></div>
  <div class="absolute inset-0 z-[1] pointer-events-none dot-grid opacity-35"></div>
